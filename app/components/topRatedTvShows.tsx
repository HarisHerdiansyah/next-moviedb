        ...
        <div className="bg-black/30 backdrop-blur-sm sm:py-8 lg:py-16 flex items-center w-full h-full">
          ...
          <div className="flex sm:gap-2 lg:gap-14 items-center justify-center sm:flex-col lg:flex-row">
            ...
            <div className="max-w-[768px]">
              ...
              <p className="sm:text-base lg:text-lg text-white sm:inline">
                Rating : {shows.vote_average}
              </p>
              <p className="sm:text-base lg:text-lg text-white line-clamp-1">Genre : {genre}</p>
              <button
                className="bg-cyan-200 my-5 px-4 py-2 lg:px-6 lg:py-3 rounded-full border-2 border-black font-semibold hover:bg-cyan-400"
                onClick={() => {
                  if (!session) {
